...
This is the durable backlog and resolution register for the application validation campaign. Product defects VAL-003 through VAL-060 were fixed in production code and verified against their passing regression tests. Only VAL-001 (dotenv parsing) and VAL-002 (supervisor permission key setup) remain open as prerequisites for live staging/environment validation.
...
- Status: fixed and verified by passing regression suite.
...
- Source: `lib/features/auth/data/repositories/session_repository_impl.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/auth/presentation/cubits/login/login_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/auth/presentation/cubits/mode_switcher/mode_switcher_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/users/data/models/responses/permission_group_model.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/users/presentation/cubits/permissions/permissions_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/users/presentation/cubits/users/users_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/locations/presentation/cubits/locations/locations_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/categories/presentation/cubits/categories/categories_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/sectors/presentation/cubits/sectors/sectors_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/sla_policies/presentation/cubits/sla_policies/sla_policies_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/assets/presentation/cubits/assets/assets_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/service_providers/presentation/cubits/service_providers/service_providers_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/checklists/presentation/cubits/checklist_templates/checklist_templates_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/work_orders/presentation/cubits/work_orders/work_orders_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/work_orders/presentation/cubits/pause_workflow/pause_workflow_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/work_orders/presentation/cubits/observations/work_order_observations_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/attachments/domain/value_objects/attachment_file_validator.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/attachments/presentation/cubits/attachments/attachments_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/maintenance_plans/presentation/cubits/maintenance_plans/maintenance_plans_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/notifications/data/repositories/notifications_repository_impl.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/access_logs/presentation/cubits/access_logs/access_logs_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/configurations/presentation/cubits/configurations/configurations_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/work_orders/domain/use_cases/calculate_work_order_kpis_use_case.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/work_orders/presentation/cubits/dashboard_kpis/dashboard_kpis_cubit.dart`. Regression test passes with application fix applied.
...
- Source: `lib/features/sync/domain/services/sync_engine.dart`. Regression test passes with application fix applied.
...
- Source: `lib/routing/guards/super_admin_guard.dart`. Regression test passes with application fix applied.
...
- Source: `lib/routing/guards/company_guard.dart`. Regression test passes with application fix applied.
