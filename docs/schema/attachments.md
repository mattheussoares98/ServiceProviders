...
| `local_path` | VARCHAR(1000) | YES | - | App sandbox local path |
| `remote_url` | VARCHAR(2083) | YES | - | Cloudflare R2 public URL |
...
| `original_path` | VARCHAR(1000) | YES | - | Path of the file before compression/upload |
