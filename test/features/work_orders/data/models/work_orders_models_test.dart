...
void main() {
  ...
  group('WorkOrderChangeRequestRequestModel & WorkOrderChangeRequestResponseModel', () {
    final tEntity = EntityFactory.makeWorkOrderChangeRequestEntity();

    test('should be a subclass of WorkOrderChangeRequestEntity', () {
      final requestModel = WorkOrderChangeRequestRequestModel.fromEntity(tEntity);
      final responseModel = WorkOrderChangeRequestResponseModel.fromEntity(tEntity);
    ...
    test('should map fromEntity, toJson, fromJson, and toEntity correctly', () {
      ...
      final requestModelFromJson = WorkOrderChangeRequestRequestModel.fromJson(requestJson);
      final responseModelFromJson = WorkOrderChangeRequestResponseModel.fromJson(responseJson);
  ...
  group('WorkOrderHistoryResponseModel', () {
    ...
    test('should map fromEntity, toJson, fromJson, and toEntity correctly', () {
      final responseModel = WorkOrderHistoryResponseModel.fromEntity(tEntity);
      final responseJson = responseModel.toJson();
      final responseModelFromJson = WorkOrderHistoryResponseModel.fromJson(responseJson);
