...
void main() {
  group('CompanyParameterEntity', () {
    test('instantiates with default values for advance warning and escalation', () {
    ...
    test('copyWith updates advance warning and escalation fields correctly', () {
      final entity = EntityFactory.makeCompanyParameterEntity();
    ...
    test('props equality holds for same attributes', () {
      final entity1 = EntityFactory.makeCompanyParameterEntity();
