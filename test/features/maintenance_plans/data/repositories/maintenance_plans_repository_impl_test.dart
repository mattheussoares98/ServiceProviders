...
void main() {
  ...
  group('MaintenancePlansRepositoryImpl', () {
    test('getMaintenancePlans should return list of plans from local data source', () async {
      // Arrange
      final companyId = faker.guid.guid();
      when(() => mockLocalDataSource.getPlans(any()))
    ...
    test('getMaintenancePlanById should return single plan from local data source', () async {
      // Arrange
      final id = faker.guid.guid();
      when(() => mockLocalDataSource.getPlanById(any()))
    ...
    test('createMaintenancePlan should return true when local save is successful', () async {
      // Arrange
      when(() => mockLocalDataSource.savePlan(any()))
    ...
    test('updateMaintenancePlan should return true when local save is successful', () async {
      // Arrange
      when(() => mockLocalDataSource.savePlan(any()))
          .thenAnswer((_) async => const SuccessState(data: true));
    ...
    test('deleteMaintenancePlan should return true when local delete is successful', () async {
      // Arrange
      final id = faker.guid.guid();
      when(() => mockLocalDataSource.deletePlan(any()))
          .thenAnswer((_) async => const SuccessState(data: true));
