-- Migration to add sla_policies, sectors, and service_providers permissions to default Supervisor permission group
-- and update the handle_new_company trigger function for newly created companies.
...
-- Seed existing default Supervisor groups with the new resource permissions
UPDATE public.permission_groups
SET permissions = permissions || '{
  "sla_policies.create": true,
  "sla_policies.update": true,
  "sla_policies.delete": true,
  "sectors.create": true,
  "sectors.update": true,
  "sectors.delete": true,
  "service_providers.create": true,
  "service_providers.update": true,
  "service_providers.delete": true
}'::jsonb
