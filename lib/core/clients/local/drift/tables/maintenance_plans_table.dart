...
class MaintenancePlans extends Table {
  ...
  TextColumn get locationId => text().nullable().references(Locations, #id, onDelete: KeyAction.setNull)();
  ...
  TextColumn get checklistTemplateId => text().nullable().references(ChecklistTemplates, #id, onDelete: KeyAction.setNull)();
