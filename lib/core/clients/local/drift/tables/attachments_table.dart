...
class Attachments extends Table {
  ...
  TextColumn get uploadedById => text().references(UserProfiles, #id, onDelete: KeyAction.cascade)();
  ...
  TextColumn get uploadStatus => text().withDefault(const Constant('pending'))(); // enum: pending, uploaded, failed
