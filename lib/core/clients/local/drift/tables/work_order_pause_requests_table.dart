...
class WorkOrderPauseRequests extends Table {
  ...
  TextColumn get requestedById =>
      text().nullable().references(UserProfiles, #id, onDelete: KeyAction.setNull)();
  TextColumn get reasonId =>
      text().nullable().references(PauseReasons, #id, onDelete: KeyAction.setNull)();
