...
class WorkOrderChangeRequestRequestModel extends WorkOrderChangeRequestEntity
    implements DataConvertible<WorkOrderChangeRequestEntity> {
  const WorkOrderChangeRequestRequestModel({
    required super.id,
  ...
  factory WorkOrderChangeRequestRequestModel.fromEntity(
    WorkOrderChangeRequestEntity entity,
  ) => WorkOrderChangeRequestRequestModel(
    id: entity.id,
  ...
  factory WorkOrderChangeRequestRequestModel.fromJson(MapDynamic json) =>
      WorkOrderChangeRequestRequestModel(
