    ...
    return ErrorHandler.execute(() async {
      ...
      final list = rows.map((row) {
        ...
        return WorkOrderModel(
          ...
          scheduledDate: order.scheduledDate?.toUtc(),
          startedAt: order.startedAt?.toUtc(),
          completedAt: order.completedAt?.toUtc(),
          ...
          deletedAt: order.deletedAt?.toUtc(),
          ...
          slaDeadlineAt: order.slaDeadlineAt?.toUtc(),
      ...
      for (final workOrder in workOrders) {
        toUpsert.add(
          WorkOrdersCompanion(
            ...
            price: Value(workOrder.price),
            currency: Value(workOrder.currency),
