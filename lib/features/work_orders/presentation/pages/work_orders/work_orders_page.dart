...
import 'package:o_jogo_da_obra/features/work_orders/presentation/pages/work_orders/widgets/pending_conclusion_app_bar_button.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BaseScaffold(
      ...
      appBar: BaseAppBar(
        ...
        actions: [
          const PendingConclusionAppBarButton(), //TODO test this
          BaseIconButton(
            onPressed: () {
              showModalPage<void>(
                WorkOrderFilters(
