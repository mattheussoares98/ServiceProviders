...
class WorkOrdersCubit extends BaseCubit<WorkOrdersState> {
  ...
  Future<bool> loadProviderWorkOrders({
    ...
    final canCreateResult = await _useCases.canProviderCreateWorkOrder(
    ...
    if (isClosed) return false;
    final canCreate = canCreateResult.data ?? false;
  ...
  Future<bool> createProviderWorkOrder({
    ...
    final allowsCreation = canCreateResult.data ?? false;
