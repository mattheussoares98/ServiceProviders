...
class CompanyParameterRequestModel extends CompanyParameterEntity
    implements DataConvertible<CompanyParameterEntity> {
  const CompanyParameterRequestModel({
    required super.id,
  ...
  factory CompanyParameterRequestModel.fromEntity(
    CompanyParameterEntity entity,
  ...
  factory CompanyParameterRequestModel.fromJson(MapDynamic json) =>
      CompanyParameterRequestModel(
  ...
  @override
  CompanyParameterEntity toEntity() => CompanyParameterEntity(
    id: id,
    companyId: companyId,
