...
class AssetResponseModel extends AssetEntity implements DataConvertible<AssetEntity> {
  ...
  factory AssetResponseModel.fromEntity(AssetEntity entity) => AssetResponseModel(
        id: entity.id,
  ...
  factory AssetResponseModel.fromJson(MapDynamic json) => AssetResponseModel(
        ...
        criticality: AssetCriticality.fromCode(json['criticality'] as String? ?? 'medium'),
