...
@LazySingleton()
class DeleteServiceProviderInvitationUseCase implements UseCase<bool, String> {
  ...
  @override
  FutureBool call(String invitationId) =>
      _serviceProviderRepository.deleteServiceProviderInvitation(invitationId);
}
