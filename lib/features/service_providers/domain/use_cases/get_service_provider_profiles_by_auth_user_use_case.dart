...
@LazySingleton()
class GetServiceProviderProfilesByAuthUserUseCase
    implements UseCase<List<ServiceProviderProfileEntity>, String> {
  ...
  @override
  FutureList<ServiceProviderProfileEntity> call(String authUserId) =>
      _serviceProviderRepository.getServiceProviderProfilesByAuthUser(authUserId);
}
